...
. Click Prepare To Group to add an API to a new or existing group. In the popup, API Manager lists the Current API Name and Current API Version. Click Edit to change the New API Name, New API Version, or to include or exclude your API portal.
+
...
+
NOTE: Do not store the environment name in the API Name or Version Name. After the upgrade, you can assign your APIs, referencing the original names, to environments
