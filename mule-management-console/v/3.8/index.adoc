...
[NOTE]
https://www.mulesoft.com/legal/versioning-back-support-policy#mule-management-console[Mule Management Console (MMC) was deprecated in December 2015]. For more information, see the link:/release-notes/mmc-migrator-tool[MMC Migrator Tool].
